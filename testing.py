...
class AESTestCase(unittest.TestCase):
    ...
    def test_decryption(self):
        ...
        plaintext = aes.decrypt(expected_ciphertext, key)
    ...
    def test_inverse_subbytes(self):
        ...
        result = aes.inverse_subBytes(state)
        self.assertEqual(result, expected_result)
    ...
    def test_inverse_shiftrows(self):
        ...
        result = aes.inverse_shiftRows(state)
        self.assertEqual(result, expected_result)

    def test_inverse_mixcolumn(self):
        aes = AES_128()
        state = [
            ['04', '66', '81', 'e5'],
            ['e0', 'cb', '19', '9a'],
        ...
        result = aes.inverse_mixColumn(state)
        self.assertEqual(result, expected_result)

    def test_inverse_addroundkey(self):
        aes = AES_128()
        state = [
            ['a4', '68', '6b', '02'],
            ['9c', '9f', '5b', '6a'],
